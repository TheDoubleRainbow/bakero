...
let AnswerButtonComponent = class AnswerButtonComponent {
    constructor() {
        this.disabled = true;
    }
    ngOnInit() {
...
let AnswerMapComponent = class AnswerMapComponent {
...
AnswerMapComponent.ctorParameters = () => [
...
let AnswerMarkerStatsComponent = class AnswerMarkerStatsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AnswerPopupComponent = class AnswerPopupComponent {
    constructor() {
        this.popupData = {
            right: {
                lat: 40,
...
let GameService = class GameService {
    ...
    makeRounds() {
        this.rounds = [];
        let roundArr = _assets_places_js__WEBPACK_IMPORTED_MODULE_3__["default"];
...
let GameComponent = class GameComponent {
    constructor(dataService, gameService, mapsAPILoader) {
        this.dataService = dataService;
...
let OpenWeatherService = class OpenWeatherService {
    ...
    getDataByGeopoint(lng, lat) {
        ...
        this.http.get(`http://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lng}&appid=${this.appId}`), this.http.get(`https://maps.googleapis.com/maps/api/elevation/json?locations=${lat},${lng}&key=${this.googleKey}`)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(data => {
            // console.log(data);
...
let QuestionImageComponent = class QuestionImageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let QuestionMapComponent = class QuestionMapComponent {
    constructor() {
        this.mapData = {
            lat: 51.678418,
            lng: 7.809007
...
let QuestionStatsComponent = class QuestionStatsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StartComponent = class StartComponent {
    constructor(gameService, formBuilder) {
        this.gameService = gameService;
